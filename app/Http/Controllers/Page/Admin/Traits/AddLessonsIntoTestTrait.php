...
trait AddLessonsIntoTestTrait{
    ...
    public function AddLessonsIntoTest( $request ){
                ...
                if( $validateLessonsIdList[ 'ok' ] ){
                    ...
                    for( $i = 0; $i < count( $lessonsIdList ); $i++ ){
                        ...
                        $model = TestLessons::where( 'test_id', '=', $testId )
                                            ...
                                            ->first();
                        if( $model === null ){
                            $testLessons = new TestLessons;
                            $testLessons->test_id = $testId;
                            $testLessons->key_name = $keyName;
                            $testLessons->lesson_id = $lessonId;
                            $testLessons->save();
                        };
